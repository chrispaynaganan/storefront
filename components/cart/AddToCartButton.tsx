  ...
  return (
    <div className="mt-8 space-y-5">
      ...
      <div>
        ...
        {selected && selected.stock_qty - qty < 5 && selected.stock_qty - qty > 0 && (
          <p className="text-xs text-brown-light mt-1">Only {selected.stock_qty - qty} left after this</p>
        )}
      </div>
      ...
      <div className="space-y-3">
        ...
        >
          {buying ? (
            ...
            qty > 1
              ? `Purchase ${qty} — ${formatPrice(total)}`
        ...
        <button
          ...
          className="w-full border border-brown text-brown font-medium py-4 rounded-full transition-colors hover:bg-brown/5 disabled:opacity-40 disabled:cursor-not-allowed"
        >
          {adding ? (
            <span className="flex items-center justify-center gap-2">
              <svg className="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
